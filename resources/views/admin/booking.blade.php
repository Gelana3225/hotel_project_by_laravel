      ...
      <!-- Sidebar Navigation end-->
        ...
        @foreach($data as $data)
            <tr>
                ...
                <td>
                    <img style="width: 100px!important;" src="/room/{{ $data->room->image }}" >
                </td>
                <td>
                  <a onclick="return confirm('Are you shure to delete this?');" class="btn btn-danger" href="{{ url('delete_booking',$data->id) }}">Delete</a>
                </td>
                <td>
